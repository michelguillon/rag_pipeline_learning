...
in review_chunks.py, not an input. See docs/LEARNING_NOTES_RAG_PIPELINE.md, "Phase 3".
...
# only config.json changes. See docs/SPEC_RAG_PIPELINE.md, Part 2 / Decision 1.
